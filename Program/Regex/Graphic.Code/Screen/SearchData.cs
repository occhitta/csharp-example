...
using ConfigData = Occhitta.Example.Config.SearchData;
using ConfigList = Occhitta.Example.Config.SearchList;
...
internal sealed class SearchData(Config.ConfigData? configData) : AbstractScreenData {
	#region メンバー変数定義
	/// <summary>
	/// 設定一覧
	/// </summary>
	private readonly ConfigList? configList = configData?.SearchList;
	/// <summary>
	/// 設定情報
	/// </summary>
	private ConfigData? configData = default;
	/// <summary>
	/// 書式内容
	/// </summary>
	...
	/// 種別一覧
	/// </summary>
	private ReadOnlyCollection<SelectData<RegexOptions>>? optionList = default;
	/// <summary>
	/// 判定内容
	/// </summary>
	private string? sourceText = default;
	/// <summary>
	/// 実行操作
	/// </summary>
	private DelegateScreenLightHook? invokeMenu = default;
	/// <summary>
	/// 状態内容
	/// </summary>
	private string? statusText = default;
	/// <summary>
	/// 結果情報
	/// </summary>
	private SourceList? resultData = default;
	#endregion メンバー変数定義
